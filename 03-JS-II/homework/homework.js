...
function esEntero(numero) {
  ...
  // pero Math.floor devuelve el maximo entero menor o igual a un numero 
  // no estaria entendiendo bien, si tenemos que saber si es un entero el dato que se pasa por parametro
